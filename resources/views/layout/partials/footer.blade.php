					...
					<div class="row gy-5">
						<div class="col-lg-4">
							<a href="demo-insurance.html" class="text-decoration-none">
								<img src="img/demos/insurance/logo.png" width="123" height="46" class="img-fluid mb-4" alt="Porto Insurance" />
							</a>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col mt-4 mb-4">
								<p class="text-center text-3 mb-0">Porto Insurance © 2025. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
