...
class B2B extends Seeder
{
    ...
    {
        $mainModule = Module::where('slug', 'b2b-b2c-framework-omnichannel')->first();

        if (!$mainModule) {
            $mainModule = Module::create([
                'title' => 'B2B E-Ticaret ve Bayi Yönetimi',
                'slug' => 'b2b-b2c-framework-omnichannel',
        ...
        $subModules = [
            ...
            [
                'title' => 'B2B Fırsat & Teklif Yönetimi',
